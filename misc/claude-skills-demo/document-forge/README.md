...
Document Forge is a demo application showcasing [Claude Skills](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview) integration with [Spring AI](https://docs.spring.io/spring-ai/reference/api/chat/anthropic-chat.html#_skills).
...
See the [Spring AI Custom Skills documentation](https://docs.spring.io/spring-ai/reference/api/chat/anthropic-chat.html#_custom_skills) for more details.
